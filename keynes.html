        ...
        <div id="content">
            <div class="container background-white">
                <div class="row margin-vert-30">
                    <div class="col-md-12">
                        <h2 class="margin-bottom-20">JOHN MAYNARD KEYNES(1883–1946)</h2>
                        <!-- Intro / Why Us? -->
                        <div class="row">

							<div class="col-md-8 animate fadeInLeft">
								<h3>PROFESSION:</h3>
									<p>Economiste, haut fonctionnaire et essayiste britannique.</p>
								<h3>THÉORIE:</h3>
									<p>Pour Keynes, une économie de marché ne possède pas de mécanisme qui la conduise de façon automatique vers le plein emploi de ses ressources, d'où la possibilité d'un chômage involontaire qui rend nécessaire une intervention extérieure au marché.</p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center margin-top-10 animate fadeInUp">
                                <h2 class="text-center margin-top-10">“La sagesse universelle enseigne qu'il vaut mieux, pour sa réputation, échouer avec les conventions que réussir contre elles.”</h2>
