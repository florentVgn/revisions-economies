        ...
        <div id="content">
            <div class="container background-white">
                <div class="row margin-vert-30">
                    <div class="col-md-12">
                        <h2 class="margin-bottom-20">Méthodologie: la dissertation en économie</h2>
                        <!-- Intro / Why Us? -->
                        <div class="row">
							<div class="col-md-12 animate fadeInLeft">
							<p>La dissertation permet d’évaluer simultanément la maîtrise des connaissances et les capacités de rédaction. La
							dissertation est révélatrice des qualités de l’élève : Esprit d’analyse et de synthèse, capacité à problématiser et à
							argumenter, aptitude à gérer son temps  ,aptitude à exprimer ses idées.</p>
							<p>Disserter s’apprend : il suffit d’en connaître les règles puis d’acquérir les « savoir-faire » par un entraînement
							systématique.</p>
							<ul>
								<li>Première étape : l’analyse du sujet</li>
								<li>Deuxième étape : mobiliser les connaissances</li>
								<li>Troisième étape : de la problématique au plan</li>
								<li>Quatrième étape : l’introduction</li>
								<li>Cinquième étape : l’argumentation</li>
								<li>Sixième étape : rédiger</li>
								<li>Septième étape : conclure</li>
								<li>Huitième étape : pour aller plus loin.</li>
							</ul>

							<h3>Première étape : l’analyse du sujet</h3>
								<p>Étape incontournable (15 mn) – pour décrypter le sujet, traiter tout le sujet, rien que le sujet – étape souvent
								négligée par l’élève !</p>
								Quatre moments de travail :
								<ul>
									<li>repérer et définir le champ d’étude : les concepts clés doivent être définis au brouillon, définitions qui
									seront ensuite utilisées dans l’introduction de la dissertation. La qualité des définitions détermine la suite
									du travail : une bonne définition met en évidence le contenu mais aussi les limites de l’objet étudié. Ceci
									permet de clarifier le « thème » du sujet et d’identifier le champ de connaissances auquel il se rattache ; on
									peut alors faire un inventaire rapide des notions clés et des références essentielles sur ce thème (historique,
									analyses, ..)</li>
									<li>comprendre le sujet : le sujet peut poser une question explicite, claire (ex : la croissance peut-elle être
									durable ?) ; mais le sujet peut rester implicite, ne pas proposer une problématique ; c’est à l’élève de
									l’expliciter en dégageant la ou les questions clés (ex : évolutions de l’entreprise et du capitalisme, depuis
									la fin du 19ème siècle).<br/>
									Dans tous les cas, il faut être attentif aux mots et expressions qui délimitent le travail à effectuer et
									respecter les consignes. (ex : analyser les relations entre… ; peut-on à juste titre parler de…)</li>
									<li>délimiter le champ du sujet : le sujet peut être général et porter sur l’ensemble de la période et des pays
									concernés ; il faudra veiller à couvrir l’ensemble du champ en variant les exemples dans le temps et dans
									l’espace. Au contraire, les champs géographique et temporel peuvent être explicitement délimités (indication du
									pays et de la période)</li>
									<li>reformuler la question : le travail d’analyse du sujet se termine avec la (re)formulation de la question.
									Au brouillon, il peut être très utile de schématiser la question.</li>
								</ul>

								<p>Exemples : pour le sujet « l’accumulation du capital est-elle la source principale de la croissance économique
								? » avec le schéma :<br/>
								Accumulation du capital –> source principale ?–> Croissance économique<br/>
								Ce qui est différent de Accumulation –>   ?                   Croissance<br/>
								Du capital                <— ?                  Économique<br/>

								Cette schématisation prépare l’explicitation et la présentation du sujet dans l’introduction.</p>
								...
								<ol>
									<li>les transformations structurelles du capitalisme impliquent des évolutions de l’entreprise</li>
									<li>réciproquement, les évolutions de l’entreprise expriment les transformations profondes du capitalisme.</li>
								</ol>
							...
							<h3>Deuxième étape : mobiliser les connaissances.</h3>
								...
								<p>Il n’y a pas de dissertation sans connaissances. Il faut mettre en relation un sujet et des connaissances. Le travail de mobilisation des connaissances s’inscrit dans le prolongement immédiat de l’analyse du sujet ; les bonnes idées s’envolent vite, il faut donc noter au brouillon les éléments qui vont soutenir votre raisonnement jusqu’à la fin de la dissertation.
									 ...
									 … puis les classer : il est nécessaire de classer et de hiérarchiser les connaissances : les notions les plus proches
									 du sujet devront être définies de façon détaillée et illustrées par des exemples approfondis ; ces explications
									 exigent à leur tour d’utiliser d’autres notions qui ne seront que brièvement explicitées (il ne faut pas les
									 approfondir, il faut les citer, elles sont bien dans le sujet et cette réflexion contribue à enrichir le sujet)</p>
							<br/>
							<h3>Troisième étape : de la problématique au plan.</h3>
							...
							<h3>Quatrième étape : l’introduction</h3>

								<p>Après avoir analysé le sujet et construit un plan adapté, on peut rédiger l’introduction.
								...
								L’expression doit être simple et claire. Il est conseillé de réutiliser les termes majeurs du sujet. Bannir les phrases
								confuses, elles sont le signe d’un plan peu rigoureux.</p>
							<h3>Cinquième étape : l’argumentation.</h3>

								<p>Une dissertation n’est ni la récitation d’un cours, ni l’affirmation d’opinions. La dissertation construit progressivement la réponse au sujet présenté dans l’introduction ; elle doit convaincre le lecteur de la pertinence de votre réponse en utilisant des notions définies, des analyses explicitées et des exemples précis situés dans le temps et dans l’espace. Argumenter, c’est mobiliser et organiser les connaissances pertinentes pour construire une réponse raisonnée aux questions soulevées par la problématique.
								...
								Gérer son temps, c’est anticiper, cadrer la dimension des arguments dès le départ, pour avoir le temps de traiter
								correctement les arguments de la fin du devoir, et de rédiger une bonne conclusion. (Il n’est pas rare de voir des
								argumentations très détaillées en début de dissertation et beaucoup plus rapides à la fin !)</p>
							<h3>Sixième étape : rédiger</h3>

								<p>Les deux premiers éléments de la dissertation (traiter le sujet, argumenter) relèvent du fond ; mais la forme est également importante !
								...
								Des expressions traditionnellement utilisées permettent de décomposer le raisonnement et faciliter la lecture.</p>

							<h3>Septième étape : conclure</h3>
								<p>Comme l’introduction, la conclusion doit être particulièrement soignée ; c’est la signature du devoir ; la
								conclusion ne doit pas être longue (une dizaine de lignes suffisent amplement puisqu’elle n’amène pas d’argument nouveaux). Etre attentif à l’expression : claire et synthétique.
								Pour ne pas bâcler cette conclusion faute de temps, il est recommandé d’en noter au brouillon les phrases clés
								immédiatement après avoir construit son plan détaillé. La conclusion comprend généralement 2 paragraphes :</p>

								<p>La réponse au sujet. Le 1er paragraphe de la conclusion répond à la question dégagée en introduction (ne pas être
								en contradiction avec l’argumentation développée dans la dissertation !)</p>

								<p>Inutile de représenter tous les arguments développés précédemment, ce serait maladroit et lourd de les résumer.
								Dans la conclusion, on doit donner une réponse à la fois synthétique et personnelle. (Académique, pas familière ou
								journalistique)</p>

								<p>Il ne faut surtout pas utiliser la conclusion pour traiter rapidement ce qui aurait été oublié dans le développement, c’est trop tard !
								...
								Éviter de finir avec un point d’interrogation : on peut suggérer une nouvelle piste sans poser pour autant une
								question.</p>
							<h3>Huitième étape : aller plus loin</h3>
							<ul>
								<li>Il faut enrichir ses connaissances</li>
								<li>Il faut s’approprier la méthodologie de la dissertation</li>
								<li>Des sujets d’examen sont disponibles dans des ouvrages ou sur Internet : s’entraîner en construisant des plans
								détaillés, en rédigeant des introductions et des conclusions</li>
								<li>Dans votre acquisition de connaissances, utiliser dictionnaires et manuels</li>
							</ul>
