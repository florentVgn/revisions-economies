...
<html lang="fr">
    ...
    <head>
        <!-- Title -->
        <title>Eugene Francis Fama</title>
        <!-- Meta -->
        ...
        <div id="content">
            <div class="container background-white">
                <div class="row margin-vert-30">
                    <div class="col-md-12">
                        <h2 class="margin-bottom-20">EUGENE FRANCIS FAMA(1939- )</h2>
                        <!-- Intro / Why Us? -->
                        <div class="row">

							<div class="col-md-8 animate fadeInLeft">
								<h3>PROFESSION:</h3>
									<p>C'est un  économiste américain.</p>
								<h3>THÉORIE:</h3>
									<p>Il a obtenu le Prix de la Banque de Suède en sciences économiques en mémoire d'Alfred Nobel en 2013 dans le domaine du marché financier. Pour son analyse empirique des prix des actifs.<br>
Eugène Fama souhaite améliorer le modèle d'évaluation des actifs MEDAF (Capital asset pricing model), et propose de rajouter au modèle d'évaluation par arbitrage (modèle MEA ou APT) des facteurs complémentaires. Ainsi, le modèle distinguerait mieux que le marché les petites valeurs (small caps) et les actions ayant un book-to-market ratio (cours/valeur comptable d'une action) élevé, source de rentabilité pour un portefeuille d'action soumis à l'HEM
                            ...
                            <div class="col-md-4 animate fadeIn">
                                <img src="assets/img/auteurs/fama.jpg" width="250"/>
                            </div>
                        </div>
                        <!-- End Intro / Why Us? -->
            ...
            <div class="container padding-vert-30">
                <div class="row">
                    ...
                    <div class="col-md-8 margin-bottom-30">
                        <h3 class="margin-bottom-10">Ces travaux</h3>
                        <p>Fama est souvent perçu comme le père de l'hypothèse d'efficience des marchés, débutée avec sa thèse de doctorat dans un article de mai 1970 du Journal of Finance, nommé « Efficient Capital Markets: A Review of Theory and Empirical Work ». Fama propose deux concepts fondamentaux qui définissent les marchés comme efficients.<br>

Le premier est le niveau d'efficience des marchés (les modèles peuvent changer en fonction de l'efficience) :
<ul>


    <li> l'efficience peut être forte ;</li>
    <li> l'efficience peut être semi-forte ;</li>
    <li> l'efficience peut être faible.</li>
</ul>
