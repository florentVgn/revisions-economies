...
L’intérêt de son modèle est de mettre en avant le rôle crucial du progrès technique dans la croissance économique. Selon ce modèle, le développement économique s'explique par trois paramètres : les deux premiers sont l’accroissement des deux principaux facteurs de production - à savoir le capital (au sens d’investissement) et le travail (quantité de main d'œuvre), et le troisième le progrès technologique.</p>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center margin-top-10 animate fadeInUp">
                                <h2 class="text-center margin-top-10">“Vous pouvez voir l'ère informatique partout, sauf dans les statistiques de la productivité.	”</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-3 margin-bottom-30">
                        ...
                        <ul class="menu">
                            ...
                            <li>
                                <a href="samuelson.html">Franco Modiglinani</a>
                            </li>
							<li>
