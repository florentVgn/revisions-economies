...
<html lang="fr">
    ...
    <head>
        <!-- Title -->
        <title>Robert Emerson Lucas Junior</title>
        <!-- Meta -->
        ...
        <div id="content">
            <div class="container background-white">
                <div class="row margin-vert-30">
                    <div class="col-md-12">
                        <h2 class="margin-bottom-20">ROBERT EMERSON LUCAS JUNIOR (1937–)</h2>
                        <!-- Intro / Why Us? -->
                        <div class="row">
							...
							<div class="col-md-8 animate fadeInLeft">
								...
								<h3>THÉORIE:</h3>
									<p>Il est à l'origine de la Nouvelle macroéconomie classique, qui veut fonder ses modèles sur les comportements individuels, les seuls à ne pas être affectés, du moins à court terme, par la politique économique mise en place par les gouvernants. Lucas se réclame donc de la théorie de l'équilibre général, qui se situe dans la même perspective.</p>
                            </div>
                            <div class="col-md-4 animate fadeIn">
                                <img src="assets/img/auteurs/lucas.jpg" width="250"/>
                            </div>
                        </div>
                        <!-- End Intro / Why Us? -->
