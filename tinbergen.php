        ...
        <div id="content">
            <div class="container background-white">
                <div class="row margin-vert-30">
                    <div class="col-md-12">
                        <h2 class="margin-bottom-20">JAN TINBERGEN (1903–1994)</h2>
                        <!-- Intro / Why Us? -->
                        <div class="row">
