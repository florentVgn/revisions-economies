...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>Gary Stanley Becker</title>
        <!-- Meta -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
							...
							<div class="col-md-8 animate fadeInLeft">
								...
								<h3>THÉORIE:</h3>
									<p>Becker développa la théorie du capital humain qui est  l'idée d'une possible augmentation du capital humain au cours du temps.</p>
                            </div>
                            <div class="col-md-4 animate fadeIn">
                                <img src="assets/img/auteurs/becker.jpg" width="250"/>
                            </div>
                        </div>
                        <!-- End Intro / Why Us? -->
