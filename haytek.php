        ...
        <div id="content">
            <div class="container background-white">
                <div class="row margin-vert-30">
                    <div class="col-md-12">
                        <h2 class="margin-bottom-20">FRIEDRICH HAYEK(1899–1992)</h2>
                        <!-- Intro / Why Us? -->
                        <div class="row">

							<div class="col-md-8 animate fadeInLeft">
								<h3>PROFESSION:</h3>
									<p>Philosophe et économiste britannique</p>
								<h3>THÉORIE:</h3>
                            ...
                            <div class="col-md-4 animate fadeIn">
                                <img src="assets/img/auteurs/haytek.jpg" width="250"/>
                            </div>
                        </div>
                        <!-- End Intro / Why Us? -->
