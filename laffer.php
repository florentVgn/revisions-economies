...
<html lang="fr">
    ...
    <head>
        <!-- Title -->
        <title>Arthur Betz Laffer</title>
        <!-- Meta -->
        ...
        <div id="content">
            <div class="container background-white">
                <div class="row margin-vert-30">
                    <div class="col-md-12">
                        <h2 class="margin-bottom-20">ARTHUR BETZ LAFFER(1940–)</h2>
                        <!-- Intro / Why Us? -->
                        <div class="row">

							<div class="col-md-8 animate fadeInLeft">
								<h3>PROFESSION:</h3>
									<p>Economiste libéral américain et chef de file de l'école de l'offre.</p>
								<h3>THÉORIE:</h3>
									<p>Il est le fondateur de la courbe de Laffer.Pour simplifier, la courbe est bâtie sur l'hypothèse d'une économie fermée (où les échanges avec l'extérieur sont ignorés) ; prendre en compte l'ouverture des frontières ne change rien au résultat de Laffer, puisque cela ne fait que rajouter la possibilité d’évasion fiscale pour les individus sur-taxés, ce qui est susceptible d’accentuer la diminution des recettes de l'État en cas d'imposition trop forte. En réalité, l'importance de l'attractivité fiscale (en particulier pour ce qui concerne l'impôt sur les sociétés) lorsque les taux d'imposition sont bas, peut mener à l'implantation de nouvelles sociétés et ainsi augmenter la base de l'impôt.</p>
                            </div>
                            <div class="col-md-4 animate fadeIn">
                                <img src="assets/img/auteurs/laffer.jpg" width="250"/>
                            </div>
                        </div>
                        <!-- End Intro / Why Us? -->
